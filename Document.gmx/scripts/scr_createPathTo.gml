...
//scr_createPathTo(startx, starty, targetx, targety, cell_size, path_curviness_1-8, obstacle_objects, diagonal)
...
while(ds_list_size(gridList) > 0){
    ...
    if (x0 == tx && y0 == ty){
        ...
        for(a = 0;a <= 3;a ++){
            ...
            if (!position_meeting(x1, y1, argument6)
